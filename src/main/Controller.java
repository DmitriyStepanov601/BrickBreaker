...
public class Controller extends JPanel implements Runnable {
	...
	public static Point mousePoint = new Point(50, 0);
	public static Font bigFont = new Font("Impact", Font.PLAIN, 25);
	...
	public Controller() {
		super();
		setPreferredSize(new Dimension(BrickBreaker.WIDTH, BrickBreaker.HEIGHT));
		setFocusable(true);
		requestFocus(true);
	}
